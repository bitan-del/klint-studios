...
export const SHOT_TYPES_LIBRARY: ShotType[] = [
  ...
  { id: 'custom', name: 'Custom...', category: 'Creative', description: 'Provide a custom shot type or pose description.' }
];
...
export const EXPRESSIONS: Expression[] = [
  ...
  { id: 'custom', name: 'Custom...', description: 'Provide a custom expression description.' }
];
...
export const APERTURES_LIBRARY: Aperture[] = [
  ...
  { id: 'custom', name: 'Custom...', description: 'Provide a custom aperture description.' }
];
...
export const ASPECT_RATIOS_LIBRARY: AspectRatio[] = [
    ...
    { id: 'ar5', name: 'Wide', value: '16:9', icon: React.createElement(RectangleHorizontal, { size: 20 }) },
];
...
export const FOCAL_LENGTHS_LIBRARY: FocalLength[] = [
  ...
  { id: 'custom', name: 'Custom...', description: 'Provide a custom focal length description.' }
];
...
export const CAMERA_ANGLES_LIBRARY: CameraAngle[] = [
    ...
    { id: 'custom', name: 'Custom...', description: 'Provide a custom camera angle description.' }
];
...
export const FABRIC_TYPES_LIBRARY: Fabric[] = [
    ...
    { id: 'custom', name: 'Custom...', description: 'Provide a custom fabric simulation description.' }
];
...
export const COLOR_GRADING_PRESETS: ColorGrade[] = [
    ...
    { id: 'custom', name: 'Custom...', description: 'Provide a custom color grade description.' }
];
...
export const LIGHTING_DIRECTIONS_LIBRARY: LightingDirection[] = [
    ...
    { id: 'custom', name: 'Custom...', description: 'Provide a custom light direction.' },
];
...
export const LIGHT_QUALITIES_LIBRARY: LightQuality[] = [
    ...
    { id: 'custom', name: 'Custom...', description: 'Provide a custom light quality.' },
];
...
export const CATCHLIGHT_STYLES_LIBRARY: CatchlightStyle[] = [
    ...
    { id: 'custom', name: 'Custom...', description: 'Provide a custom catchlight style.' },
];
...
export const PRODUCT_INTERACTION_LIBRARY: ProductInteraction[] = [
    ...
    // FIX: Add a description to the 'custom' object to satisfy the updated ProductInteraction type.
    { id: 'custom', name: 'Custom...', description: 'Provide a custom interaction description.' },
];
...
export const SURFACE_LIBRARY: Surface[] = [
    ...
    { id: 'custom', name: 'Custom...', description: 'Provide a custom surface description.' },
];
...
export const PRODUCT_MATERIAL_LIBRARY: Material[] = [
    ...
    { id: 'custom', name: 'Custom...', description: 'Provide a custom material description.', category: 'Standard' },
