    ...
    return (
        <AuthLayout>
                ...
                {success ? (
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        <div className="relative group animate-fade-in delay-[400ms]">
                            <User className="absolute left-3.5 top-1/2 -translate-y-1/2 text-zinc-500 group-focus-within:text-emerald-400 transition-colors" size={20} />
                            <input
                                type="text"
                                ...
                                required
                                className="w-full p-3 pl-11 rounded-lg bg-zinc-900 text-zinc-200 border border-zinc-700/80 focus:ring-2 focus:ring-emerald-500/50 focus:border-emerald-500 transition-colors shadow-inner-soft placeholder:text-zinc-500"
                            />
                        </div>
                        <div className="relative group animate-fade-in delay-500">
                            <Mail className="absolute left-3.5 top-1/2 -translate-y-1/2 text-zinc-500 group-focus-within:text-emerald-400 transition-colors" size={20} />
                            <input
                                type="email"
                        ...
                        <div className="relative group animate-fade-in delay-[600ms]">
                            <Lock className="absolute left-3.5 top-1/2 -translate-y-1/2 text-zinc-500 group-focus-within:text-emerald-400 transition-colors" size={20} />
                            <input
                                type="password"
            ...
            <p className="text-center text-sm text-zinc-400 mt-8 animate-fade-in delay-[800ms]">
                ...
                <a href="./login.html" className="font-bold text-emerald-400 hover:text-emerald-300 transition-colors">
                    Sign in
                </a>
            </p>
        </AuthLayout>
