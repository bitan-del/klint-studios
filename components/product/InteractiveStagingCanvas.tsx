                ...
                >
                    ...
                    <div className="absolute -top-8 left-1/2 -translate-x-1/2 flex items-center gap-1 bg-zinc-900/80 p-1 rounded-md opacity-0 group-hover:opacity-100 transition-opacity z-10">
                     ...
                     <div 
                        ...
                        className="absolute -right-1 -bottom-1 w-4 h-4 bg-emerald-500 rounded-full border-2 border-zinc-900 cursor-nwse-resize opacity-0 group-hover:opacity-100 transition-opacity z-10"
                    />
                </div>
            ))}
        </div>
