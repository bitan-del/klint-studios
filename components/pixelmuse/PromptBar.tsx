      ...
      <div className="max-w-4xl mx-auto bg-[#1e1f20] rounded-2xl p-4 shadow-2xl shadow-black/50">
        <div className="flex items-start space-x-4">
          ...
          <button
            ...
            className="self-end px-6 py-3 bg-emerald-500 hover:bg-emerald-400 text-white font-semibold rounded-xl flex items-center space-x-2 transition-all duration-200 ease-in-out hover:scale-105 disabled:bg-gray-600 disabled:cursor-not-allowed disabled:scale-100"
          >
            {isLoading ? (
