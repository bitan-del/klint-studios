...
export const AspectRatioIcon: React.FC = () => (
  <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
    <rect x="2.5" y="4.5" width="11" height="7" rx="1" stroke="currentColor"/>
  </svg>
);
...
export const ImageIcon: React.FC<{className?: string}> = ({ className="text-gray-400" }) => (
...
export const SelectIcon: React.FC<{className?: string}> = ({ className }) => (
    <svg className={className} width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
        <path d="M4.35 3.35l16.3 6.11a1 1 0 010 1.88L4.35 21.65a1 1 0 01-1.3-1.3l2.88-6.92a1 1 0 000-.86L3.05 4.65a1 1 0 011.3-1.3z"/>
    </svg>
);
