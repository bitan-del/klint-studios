...
const TOUR_STEPS = [
  {
    ...
    title: '1. Add Inputs',
    description: "Start by selecting your Person and Clothing. You can upload your own, choose from our library, or describe a person with a prompt.",
    position: 'right',
  },
  {
  ...
  },
  {
    ...
    description: "Fine-tune the details like a real photographer. Adjust the camera angle, pose, expression, and more.",
    position: 'left',
  },
  {
    ...
    <div className="fixed inset-0 z-[100]">
        ...
        >
            ...
            <div className="flex justify-between items-center mb-3">
                <h3 className="text-lg font-bold text-emerald-300">{currentStepConfig.title}</h3>
            ...
            <div className="flex justify-between items-center">
                ...
                <div className="flex items-center gap-2">
                    ...
                    >
                     ...
                     <button 
                        onClick={handleNext} 
                        className="flex items-center gap-2 py-2 px-4 rounded-full bg-emerald-600 hover:bg-emerald-500 font-semibold text-sm transition-colors"
                    >
