...
export const PricingModal: React.FC<PricingModalProps> = ({ isOpen, onClose }) => {
    const { planPrices, currency } = useAuth();
                ...
                <div className="p-4 sm:p-8 space-y-8 max-h-[85vh] overflow-y-auto">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 items-start">
                        ...
                        <div className="bg-zinc-900 p-6 rounded-xl border border-zinc-800 flex flex-col h-full">
                            ...
                            <p className="mt-4 text-zinc-300"><span className="text-4xl font-bold text-white">{currencySymbol}{planPrices.solo}</span> / month</p>
                        ...
                        <div className="relative bg-zinc-900 p-6 rounded-xl border-2 border-emerald-500 flex flex-col shadow-glow-lg h-full -mt-0 md:-mt-3">
                             <div className="absolute top-0 -translate-y-1/2 left-1/2 -translate-x-1/2">
                                <span className="bg-emerald-600 text-white text-xs font-semibold px-4 py-1 rounded-full uppercase tracking-wider">Most Popular</span>
                            </div>
                            <h4 className="text-xl font-bold text-white">Brand</h4>
                            <p className="mt-4 text-zinc-300"><span className="text-4xl font-bold text-white">{currencySymbol}{planPrices.brand}</span> / month</p>
                            ...
                            <button className="w-full mt-8 bg-emerald-600 hover:bg-emerald-500 text-white font-semibold py-2.5 px-4 rounded-lg transition-colors">Choose Plan</button>
                        </div>

                        {/* Studio Plan */}
                         <div className="bg-zinc-900 p-6 rounded-xl border border-zinc-800 flex flex-col h-full">
                            <h4 className="text-xl font-bold text-white">Studio</h4>
                            <p className="mt-4 text-zinc-300"><span className="text-4xl font-bold text-white">{currencySymbol}{planPrices.studio}</span> / month</p>
