...
import { User, Settings, LogOut, CreditCard, Menu, X, Layers, Zap } from 'lucide-react';
                                        ...
                                        <>
                                            ...
                                            <div className="absolute right-0 mt-2 w-64 bg-zinc-950/95 border border-white/10 rounded-xl shadow-2xl backdrop-blur-2xl z-50">
                                                ...
                                                <div className="p-2">
                                                    {onSwitchToAdvanced && (
                                                        <button
                                                            onClick={() => { onSwitchToAdvanced(); setShowUserMenu(false); }}
                    ...
                    {isMobileMenuOpen && (
                        <div className="md:hidden mt-4 pt-4 border-t border-zinc-800 px-6">
                            <div className="space-y-2">
                                ...
                                {onSwitchToAdvanced && (
                                    <button
                                        onClick={() => { onSwitchToAdvanced(); setIsMobileMenuOpen(false); }}
                                    ...
                                    <>
                                        <div className="px-3 py-2 bg-zinc-800 rounded-lg text-sm">
                                            ...
                                            <span className="text-zinc-100 font-semibold">
                                                {user.dailyGenerationsUsed || 0} / 10
                                            </span>
                                        </div>
                                        <button
                                            onClick={onOpenPayment}
            ...
            <div className="flex-1 flex flex-col min-h-0">
                {currentWorkflow ? (
                    currentWorkflow === 'storyboard' ? (
                        ...
                        <SocialMediaPostsWorkflow onBack={handleBackToDashboard} />
                    ) : (
                        <SimplifiedWorkflow
