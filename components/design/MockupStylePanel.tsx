            ...
            <div>
                 ...
                 <div className="relative">
                    <textarea
                        ...
                        rows={3}
                        className="w-full p-2.5 pr-12 rounded-md bg-zinc-850 text-zinc-200 border border-zinc-700 focus:ring-1 focus:ring-violet-500/50 focus:border-violet-500 transition-colors text-sm shadow-inner-soft"
                    />
                    <PromptOptimizer
                        prompt={designPlacementControls.apparelType}
                        setPrompt={(v) => updateDesignPlacementControl('apparelType', v)}
                        context="Describing the style and color of a blank apparel item for a mockup"
