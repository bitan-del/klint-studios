-- PixelMuse Setup Migration
-- Run this in Supabase SQL Editor to create all PixelMuse tables
...
DROP TRIGGER IF EXISTS update_pixel_muse_profiles_updated_at ON pixel_muse_profiles;
...
-- Trigger to auto-update updated_at
DROP TRIGGER IF EXISTS update_pixel_muse_generations_updated_at ON pixel_muse_generations;
